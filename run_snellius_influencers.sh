...
# Runs run_experiment_influencers.jl (the Sobol/Saltelli sweep; 491,520 sims = 16,384 x 30)
...
#        ~/fake-news-percolation/run_snellius_influencers.sh   (this file)
...
#   4. Submit:   sbatch run_snellius_influencers.sh true
...
#   (not the --time cap). The full Sobol sweep is 491,520 sims (16,384 design points x
#   30 replications), but write_full=false skips the heavy per-node/edge/cascade Arrow files
...
# Submit form:  `sbatch run_snellius_influencers.sh true`.
